...
<%
	...
	System.out.println(userInfo.get("lookStar"));
	if(userInfo.get("lookStar").equals("yes")){
		OnlyRight myRight = new OnlyRight();
		contact_table =  myRight.getStarTable(user_id).toString();
	}else if(userInfo.get("lookStar").equals("no")){
		
		contact_table =  "<tr>\r\n" + 
    			"<td colspan=\"5\" style=\"color:#2e005b;font-size:20px;\">"+"您暂时没有查看星标合同的权限，只有业务部人员可以查看自己的星标合同，感谢理解！"+"</td>\r\n";
	}
