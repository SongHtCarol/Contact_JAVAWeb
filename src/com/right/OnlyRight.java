...
public class OnlyRight {
	private static OnlyRight instance = null;

    public static OnlyRight getInstance() {
        if (instance == null) {
            instance = new OnlyRight();
        }
        return instance;
    }
    
    public StringBuilder getContactTable(String user_id) {
        ...
        try {
            ...
            String sql1 = "SELECT * \r\n" + 
            		...
            		"where s_contacts.user_id='"+user_id+"';";
...
public StringBuilder getStarTable(String user_id) {
    ...
    public StringBuilder getCusTable(String user_id) {
    	Connection conn = null;
    ...
    public StringBuilder getVIP(String user_id) {
    	StringBuilder vipTable = new StringBuilder();
    	Connection conn = null;
        ...
        try {
            ...
            String sql1 = "SELECT * \r\n" + 
            		"FROM \r\n" + 
            		"s_customers\r\n" + 
            		"where s_customers.user_id='"+user_id+"';";
            Statement stmt=(Statement) conn.createStatement();                                                                                             // SQL语句=
            ResultSet rs=stmt.executeQuery(sql1); // 创建用户操作执行SQL语句的PreparedStatement对象
            ...
            while(rs.next()) {
            	...
            	vipTable.append("<tr>\r\n" + 
            			...
            			"<td>"+rs.getString("cus_phone")+"</td>\r\n" + 
            			"<td>\r\n" + 
            			"<a id=\"\" href=\"#modal-VIP-info\" onclick=\"viewVIP(event,"+cus_id+")\" role=\"button\" class=\"btn  btn-default view-VIP-btn\" data-toggle=\"modal\">会员详情</a>	\r\n" + 
            			"<a id=\"\" href=\"#modal-container-819866\" onclick=\"cancelVIP(event"+cus_id+")\" role=\"button\" class=\"btn  btn-default cancel-btn\" data-toggle=\"modal\">移除VIP</a>	\r\n" + 
            			"</td>\r\n" + 
            			"</tr>");
            }rs.last();
    ...
    public StringBuilder getNewContact(String user_id) {
    	StringBuilder newContactTable = new StringBuilder();
    	Connection conn = null;
        try {
            conn = (Connection) MySQLDBCon.getCon(); // 建立数据库连接
            ...
            String sql1 = "SELECT * \r\n" + 
            		"FROM project.s_contacts \r\n" + 
            		"where user_id = '"+user_id+"'\r\n" + 
            		"order by s_contacts.effective_date desc ;";
            Statement stmt=(Statement) conn.createStatement();                                                                                             // SQL语句=
            ResultSet rs=stmt.executeQuery(sql1); // 创建用户操作执行SQL语句的PreparedStatement对象
